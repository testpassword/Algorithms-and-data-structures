...
/*
Нужно постороить и вывести дерево каталогов, по аналогии с командой 'tree'. Самый простой вариает - 
сохранить все строки в массив, парсит по первому символу '\' и создавать новую цепочку в связнанном списке. 
...
Теперь надо вывести полученную строктуру. Для этого, будем рекурсивно опускаться вглубь каждой директории, 
